...
<Page home="false">
  <div class="mx-auto my-20 max-w-5xl mt-24 font-baloo2 px-20">
    <h1 class="font-vollkorn text-3xl"><strong>Terms &amp; Conditions</strong></h1>
    <br>
    <p>
    ...
    <br>
    <p>
      Neil Agrawal is committed to ensuring that the app is
    ...
    <br>
    <p>
      The PeaceBox app stores and processes personal data that
    ...
    <br>
    <p>
      Along the same lines, Neil Agrawal cannot always take
    ...
    <br>
    <p>
      With respect to Neil Agrawal’s responsibility for your
